...
if [ ! -f freebase/freebase.nt.gz ]; then
    wget -O freebase/freebase.nt.gz http://commondatastorage.googleapis.com/freebase-public/rdf/freebase-rdf-latest.gz
fi
...
wget -N --directory-prefix=dbp_en \
    ...
    http://downloads.dbpedia.org/3.9/en/specific_mappingbased_properties_en.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/en/labels_en.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/en/short_abstracts_en.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/en/long_abstracts_en.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/en/images_en.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/en/geo_coordinates_en.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/en/raw_infobox_properties_en.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/en/raw_infobox_property_definitions_en.ttl.bz2 \
...
wget -N --directory-prefix=dbp_es \
    ...
    http://downloads.dbpedia.org/3.9/es/specific_mappingbased_properties_es.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/es/labels_es.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/es/short_abstracts_es.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/es/long_abstracts_es.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/es/images_es.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/es/geo_coordinates_es.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/es/raw_infobox_properties_es.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/es/raw_infobox_property_definitions_es.ttl.bz2 \
...
wget -N --directory-prefix=dbp_it \
    ...
    http://downloads.dbpedia.org/3.9/it/specific_mappingbased_properties_it.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/it/labels_it.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/it/short_abstracts_it.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/it/long_abstracts_it.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/it/images_it.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/it/geo_coordinates_it.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/it/raw_infobox_properties_it.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/it/raw_infobox_property_definitions_it.ttl.bz2 \
...
wget -N --directory-prefix=dbp_nl \
    ...
    http://downloads.dbpedia.org/3.9/nl/specific_mappingbased_properties_nl.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/nl/labels_nl.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/nl/short_abstracts_nl.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/nl/long_abstracts_nl.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/nl/geo_coordinates_nl.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/nl/raw_infobox_properties_nl.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/nl/raw_infobox_property_definitions_nl.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/nl/interlanguage_links_nl.ttl.bz2 \
    http://downloads.dbpedia.org/3.9/nl/article_categories_nl.ttl.bz2 \
