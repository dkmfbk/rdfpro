...
import eu.fbk.rdfpro.groovy.GroovyProcessor.GroovyLiteral;
...
final class SparqlFunctions {
    ...
    public static BNode bnode(final Object arg) {
        ...
        Util.checkNotNull(arg);
        return Statements.VALUE_FACTORY.createBNode(Util.murmur3str(arg.toString()));
    }
