...
final class InferencerProcessor extends RDFProcessor {
    ...
    InferencerProcessor(final Iterable<? extends Statement> tbox,
    ...
    public RDFHandler getHandler(final RDFHandler handler) {
        return new Handler(Util.checkNotNull(handler), this.ruleset, this.tbox, this.emitTbox);
    }
        ...
        TBox(final Database database, @Nullable final Resource context) {
            ...
            for (final Statement statement : database) {
                ...
                statementArray[index++] = Objects.equals(context, statement.getContext()) ? statement
                        : context == null ? Util.FACTORY.createStatement(s, p, o) : Util.FACTORY
    ...
    private static final class ABoxInferencer {
        ...
        private Statement create(final Resource subject, final URI predicate, final Value object) {
            return this.context == null ? Util.FACTORY.createStatement(subject, predicate, object)
                    : Util.FACTORY.createStatement(subject, predicate, object, this.context);
        }
    ...
    private static final class Ruleset {
        ...
        Ruleset(final String... rules) {
            ...
            if (!set.isEmpty()) {
                throw new IllegalArgumentException("Unknown rule(s): " + Util.join(", ", set));
            }
        }
        ...
        private static final class Triple {
            ...
            public Statement getStatement() {
                if (this.statement == null) {
                    this.statement = Util.FACTORY.createStatement(this.subj, this.pred, this.obj);
                }
